...
public class MyLoggingEventListenerProvider implements EventListenerProvider {
    ...
    public MyLoggingEventListenerProvider(KeycloakSession session, Logger logger, Logger.Level successLevel, Logger.Level errorLevel) {
    ...
    public void onEvent(Event event) {
        ...
        System.out.println("MyLoggingEventListener-Event: " + event.getTime() + ", " + event.getType().name() + ", " + event.getUserId());
    ...
    public void onEvent(AdminEvent adminEvent, boolean includeRepresentation) {
        ...
        sb.append("MyEventListener-AdminEvent: ");
